  ...
  return (
    <footer className="bg-red-600">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-4 rounded-lg bg-green-600 p-6 shadow-lg sm:flex-row sm:justify-between">
          <strong className="text-xl text-white sm:text-xl">
            Escribinos directo a nuestro Whatsapp!
          </strong>
          ...
          >
            {" "}
            <BsWhatsapp />
            <span className="text-sm font-medium">Mensajeanos </span>
            <svg
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div className="mx-auto max-w-sm lg:max-w-none">
            ...
            <div className="mt-6 flex justify-center gap-4 lg:justify-start">
              <a
                className="text-slate-200 transition hover:text-gray-800/75"
                href=""
                target="_blank"
                rel="noreferrer"
              >
        ...
        <div className="mt-16">
          <div className="mt-16 sm:flex sm:items-center sm:justify-between">
            ...
            <p className="mt-4 text-center text-sm text-slate-200 sm:mt-0 sm:text-right">
              Critikal &copy; 2023. All rights reserved.
            </p>
          </div>
        </div>
      </div>
